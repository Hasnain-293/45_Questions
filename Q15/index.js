...
let Name = "Guest List:-";
let ChangingGuestlist = ["Pearl Continental Hotel Dinner: " + "Mr. Hasnain Mughal with Family",
    "Pearl Continental Hotel Dinner: " + "Mr. Fazeel with Family",
    "Pearl Continental Hotel Dinner: " + "Mr. Waheed Murad with Family"];
console.log(Name);
console.log(ChangingGuestlist);
ChangingGuestlist.pop();
console.log(ChangingGuestlist); //Remove Mr.Waheed Murad with Family - Q15
